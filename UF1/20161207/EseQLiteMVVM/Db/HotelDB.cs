...
namespace EseQLite.Db
{
    class HotelDB
    {
        ...
        public static long insertData( string pNom, string pPoblacio)
        {
            using (HotelContext ctx = new HotelContext())
            {
                ...
                using (var connection = ctx.Database.GetDbConnection())
                {
                    ...
                    using (var command = connection.CreateCommand())
                    {
                        try
                        {
                            command.CommandText = "insert into hotel (htl_nom , htl_poblacio) values(:nom, :poblacio) ";
                            command.Transaction = trans;
        ...
        */
        public static void updateData(long pCodi, string pNom, string pPoblacio)
        {
            using (HotelContext ctx = new HotelContext())
            {
